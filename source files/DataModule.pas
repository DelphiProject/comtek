...
{ Действие создания формы MDIСhild оператора, которое отображается в меню программы }
...
{ Действие создания формы MDIСhild статиста, которое отображается в меню программы }
...
{ Действие создания формы подключения к БД, которое отображается в меню программы }
