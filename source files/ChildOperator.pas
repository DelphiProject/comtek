...
begin
  ...
  { Динамическое создание редактируемого запроса с выборкой 10 последних
    добавленных людей }
  ...
  { Создание DataSource для ранее созданных запросов }
  ...
  C_Q_DS.Name := 'CQDS_' + s;
  C_Q_DS.DataSet := C_Q;
  { Подключение DataSource к DBGrid и  автоматическое расширение ячеек Grid
    по содержимому }
