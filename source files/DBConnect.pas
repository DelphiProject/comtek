...
begin
  ...
  {Загрузка параметров подключения к БД из INI-файла на форму в момент ее появления}
...
{Сохранение параметров подключения к БД в INI-файла}
...
{Очистка параметров подключения к БД в INI-файле}
